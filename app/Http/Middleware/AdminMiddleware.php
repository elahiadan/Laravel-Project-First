...
class AdminMiddleware
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        {
            return redirect('/home')->with('status','You are not allowed to access the CRUD Application // This is a local User Page // Please Login with Admin User // admin@gmail.com // 12345678');
        }
